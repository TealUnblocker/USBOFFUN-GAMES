...
class Game {
    ...
    showTutorial(type = 'night1') {
        ...
        if (type === 'night2') {
            ...
            tutorialContent.innerHTML = `
                <h2>DEFEND YOURSELF AGAINST NIALL</h2>
                <p>
                    NIALL WILL TRY TO ATTACK YOU THROUGH THE VENTS IN CAM 1 AND CAM 2, SO IF YOU HEAR BANGING IN THE VENTS HEAD OVER TO THE CONTROL PANEL AND CLOSE THEM. 
                    ...
                    NIALL CAN BE LURED WITH THE AUDIOS BUT YOUR MAIN PRIORITY WITH THE AUDIO LURES SHOULD BE MICHAEL.
                </p>
            ...
            // Night 3 教程：霍金
            tutorialContent.innerHTML = `
                <h2>DEFEND YOURSELF AGAINST LIAM</h2>
                <p>
                    LIAM ALWAYS STAYS AT CAM 6 AND HE IS NOT AFFECTED BY THE AUDIO LURES. 
                    ELECTROCUTE LIAM EVERY ONCE IN A WHILE TO PREVENT HIM FROM LEAVING CAM 6.
                </p>
                <button id="tutorial-got-it">GOT IT</button>
            `;
            // 重新绑定按钮事件
            ...
            // Night 1 教程：EP
            tutorialContent.innerHTML = `
                <h2>DEFEND YOURSELF AGAINST MICHAEL</h2>
                <p>
                    MICHAEL ALWAYS STARTS AT CAM 11. USE THE CAMERA'S AUDIO LURE TO KEEP MICHAEL FAR AWAY FROM YOU. 
                    MAKE SURE THE CAMERA YOU'RE PLAYING THE SOUND IN IS NEXT TO THE CAMERA WHERE MICHAEL IS. 
                    ...
                    TO FIX THEM HEAD TO THE CONTROL PANEL AND RESTART THE CAMERAS. 
                    MICHAEL DOES NOT ATTACK THROUGH THE VENTS SO DON'T BOTHER CLOSING THEM FOR THIS NIGHT.
                </p>
                <button id="tutorial-got-it">GOT IT</button>
            `;
            // 重新绑定按钮事件
    ...
    // Golden 霍金彩蛋效果
    showGoldenStephen() {
        console.log('🌟 Golden Liam appears!');
    ...
    playNight6VictoryAnimation() {
        ...
        setTimeout(() => {
            ...
            setTimeout(() => {
                ...
                night6Image.src = 'assets/images/winscreen.png';
